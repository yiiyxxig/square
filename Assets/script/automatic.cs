...
public class automatic : MonoBehaviour, IPointerClickHandler
{
    ...
    public void OnPointerClick (PointerEventData eventData)
    {
        ...
        {
            notcorrect.GetComponent<ImageChange2_S2>().ChangeImageX();
        }
        ...
        MouseDown.GetComponent<OnMouseDown1_S2>().OnMouseDown();
    }
}
